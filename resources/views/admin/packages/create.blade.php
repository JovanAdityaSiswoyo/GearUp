...
<body class="bg-gray-50">
    ...
    <div class="min-h-screen">
        ...
        <div class="ml-64">
            @include('admin.partials.header', ['title' => 'Create Package'])

            <main class="p-8">
                <div class="max-w-2xl mx-auto">
                    <div class="bg-white rounded-xl shadow-sm p-8">
                        <h2 class="text-2xl font-bold text-gray-800 mb-6">Add New Package</h2>
                        ...
                        <form action="{{ route('admin.packages.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="duration_days" name="duration_days" value="{{ old('duration_days') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-gray-100" readonly>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="datetime-local" id="start_publish" name="start_publish" value="{{ old('start_publish') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" required>
                                    ...
                                    <div>
                                        ...
                                        <input type="datetime-local" id="end_publish" name="end_publish" value="{{ old('end_publish') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" required>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Upload package image (JPG, PNG, max 2MB)</p>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Select multiple images for gallery</p>
                                ...
                                <div>
                                    ...
                                    <div class="border border-gray-300 rounded-lg p-4 max-h-60 overflow-y-auto">
                                        ...
                                        <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                                            ...
                                            <div class="ml-3">
                                                <input type="number" name="products_qty[]" value="{{ old('products_qty.' . $loop->index, 1) }}" min="1" 
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="number" id="price" name="price" value="{{ old('price', 0) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-gray-100" readonly>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="upsell" name="upsell" value="{{ old('upsell', 0) }}" min="0" step="5000" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">
