...
<head>
    ...
    <title>Create Brand - Admin</title>
...
<body class="bg-gray-50">
    ...
    <div class="min-h-screen">
        ...
        <div class="ml-64">
            @include('admin.partials.header', ['title' => 'Create Brand'])

            <main class="p-8">
                <div class="max-w-2xl mx-auto">
                    <div class="bg-white rounded-xl shadow-sm p-8">
                        <h2 class="text-2xl font-bold text-gray-800 mb-6">Add New Brand</h2>
                        ...
                        <form action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Upload brand logo (JPEG, PNG, GIF, max 2MB)</p>
