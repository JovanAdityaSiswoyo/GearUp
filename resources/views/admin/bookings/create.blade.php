...
<body class="bg-gray-50">
    ...
    <div class="min-h-screen">
        ...
        <div class="ml-64">
            @include('admin.partials.header', ['title' => 'Create Booking'])

            <main class="p-8">
                <div class="max-w-3xl mx-auto">
                    <div class="bg-white rounded-xl shadow-sm p-8">
                        <h2 class="text-2xl font-bold text-gray-800 mb-6">Add New Booking</h2>
                        ...
                        <form action="{{ route('admin.bookings.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" name="checkin_appointment_start" value="{{ old('checkin_appointment_start') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
                                    @error('checkin_appointment_start') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Check-out Date *</label>
                                    <input type="datetime-local" name="checkout_appointment_end" value="{{ old('checkout_appointment_end') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
                                    @error('checkout_appointment_end') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Amount *</label>
                                    <input type="number" name="amount" value="{{ old('amount', 1) }}" min="1" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="booker_name" value="{{ old('booker_name') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="booker_email" value="{{ old('booker_email') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="booker_telp" value="{{ old('booker_telp') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
