...
<body class="bg-gray-50">
    <div class="min-h-screen">
        <!-- Sidebar -->
        <aside class="fixed top-0 left-0 h-screen w-64 bg-gradient-to-b from-blue-600 to-cyan-500 text-white overflow-y-auto z-40">
            <div class="p-6">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('officer.packing.index') }}" class="flex items-center px-6 py-3 hover:bg-white/10 transition {{ request()->routeIs('officer.packing.*') ? 'bg-white/20 border-r-4 border-white' : '' }}">
